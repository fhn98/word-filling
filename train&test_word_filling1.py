...
# do not use reading from file in an important module like train
# embedding_array, filename, ... should be variable not a file address
# test should not be in the train but a dependent module
